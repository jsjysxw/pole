...
import cn.com.avatek.pole.drawmap.utils.LooperFlag;
import cn.com.avatek.pole.drawmap.utils.MoveAndScaleHandler;

import static cn.com.avatek.pole.drawmap.utils.DensityUtils.dp2px;
...
public class TreeView extends ViewGroup implements ScaleGestureDetector.OnScaleGestureListener {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mTreeLayoutManager != null && mTreeModel != null) {
            ...
            setMeasuredDimension(viewBox.right+ Math.abs(viewBox.left)+2000,viewBox.bottom+ Math.abs(viewBox.top)+2000);
